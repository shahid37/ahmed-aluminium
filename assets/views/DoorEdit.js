...
export default class Listing extends React.Component {
    ...
    componentDidMount() {
        getDataDoor((data) => {
            ...
            AsyncStorage.setItem('doors', JSON.stringify(this.state.ResTotal));
        })
    ...
    render() {
        ...
        return (
            ...
            renderItem={({item}) => { */}
                                ...
                                <View style={styles.eventContent}>
                                    {item.width > 0 &&
                                        <View>
                                            ...
                                            <Text style={styles.userName}>Thickness D50A     {item.finalThickness2}</Text>
                                            <Text style={styles.userName}>Material D50A      {item.finalMaterial2}</Text>
                                            <Text style={styles.userName}>Width D50A         {item.width2}</Text>
                                            <Text style={styles.userName}>Height D50A        {item.height2}</Text>
                    ...
                    {/* // }}/> */}
                    <View>
                        <Text style={{ textAlign: "center", fontSize: 20 }}>Total Value For Doors is {this.state.ResTotal}</Text>
                    </View>
                </ScrollView>
            </View>
        );
