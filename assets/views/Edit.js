...
import { Text, View, StyleSheet,AsyncStorage,
    TextInput,
    Button,
    TouchableHighlight,
    Alert,
...
import {getData} from "../views/Utills"
...
export default class Listing extends React.Component {
  ...
  componentDidMount(){
    ...
    AsyncStorage.setItem('gsl', JSON.stringify(this.state.ResTotal));
    })
          ...
          {/* <FlatList 
            ...
            renderItem={({item}) => { */}
              ...
              <View style={{flex:1,justifyContent:"center"}}>
               ...
               return <TouchableOpacity onPress={() => this.props.navigation.navigate("GSL",{saveIndex:index})}>
                  <View style={styles.eventBox}>
                    ...
                    <View style={styles.eventContent}>
                      <Text  style={styles.eventTime}>Calculator GSL</Text>
                      <Text  style={styles.userName}>Thickness -{item.finalThickness}</Text>
                      <Text  style={styles.userName}>Material -{item.finalMaterial}</Text>
                      <Text  style={styles.userName}>Width -{item.name}</Text>
                      <Text  style={styles.userName}>Height -{item.name2}</Text>
                      <Text  style={styles.userName}>Final Result -{item.singleResult}</Text>
                ...
                <View>
                  <Text style={{textAlign:"center",fontSize:20}}>Total Value For GSL is {this.state.ResTotal.toFixed(2)}</Text>
                </View>
              {/* ) */}
            {/* // }}/> */}
            </ScrollView>
