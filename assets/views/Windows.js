...
class Home extends React.Component {
      ...
      if (saveIndexx != -1) {
        getDataWindow((record) => {
          this.setState({
            ...
            data: {
              ...data,
              width: record[saveIndexx].width,
              height: record[saveIndexx].height,
              width2: record[saveIndexx].width2,
              height2: record[saveIndexx].height2,
              ...
              width3: record[saveIndexx].width3,
              height3: record[saveIndexx].height3,
              width4: record[saveIndexx].width4,
              height4: record[saveIndexx].height4,
              ...
              width5: record[saveIndexx].width5,
              height5: record[saveIndexx].height5,
              width6: record[saveIndexx].width6,
              height6: record[saveIndexx].height6,
              ...
              width7: record[saveIndexx].width7,
              height7: record[saveIndexx].height7,
              width8: record[saveIndexx].width8,
              height8: record[saveIndexx].height8,
              ...
              width9: record[saveIndexx].width9,
              height9: record[saveIndexx].height9,
  ...
  async final() {
    ...
    // AsyncStorage.setItem('windows', JSON.stringify(aaaa));
      ...
      <View>
        <View
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() => {
                this.setState({fixed: true, sliding: false, double: false});
              }}
              activeOpacity={0.7}
              style={{
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() => {
                this.setState({sliding: true, fixed: false, double: false});
              }}
              activeOpacity={0.7}
              style={{
          ...
          <View
            ...
            <TouchableOpacity
              onPress={() => {
                this.setState({double: true, sliding: false, fixed: false});
              }}
              activeOpacity={0.7}
              style={{
            ...
            <View>
              ...
              <View
                ...
                <View style={{flexDirection: 'row'}}>
                  <TouchableOpacity
                    onPress={() => {
                      this.setState({D42: true, D54A: false});
                    }}
                    activeOpacity={0.7}
                    style={{
                      backgroundColor: D42Color,
                      padding: Width(4),
                      width: Width(43),
                      borderRadius: 5,
                    }}>
                ...
                <View
                  style={{flexDirection: 'row', marginHorizontal: Width(4)}}>
                  <TouchableOpacity
                    onPress={() => {
                      this.setState({D42: false, D54A: true});
                    }}
                    activeOpacity={0.7}
                    style={{
                      backgroundColor: D54AColor,
                      padding: Width(4),
                      width: Width(43),
                      borderRadius: 5,
                    }}>
                      ...
                      <View style={{marginTop: Height(-1)}}>
                        ...
                        <View style={styles.txtInputView}>
                          <TextInput
                            ...
                            onChangeText={(text) =>
                              this.setState({data: {...data, width: text}})
                            }
                            value={data.width}
                      ...
                      <View style={{marginTop: Height(-3)}}>
                        ...
                        <View style={styles.txtInputView}>
                          <TextInput
                            ...
                            onChangeText={(text) =>
                              this.setState({data: {...data, height: text}})
                            }
                            value={data.height}
                            placeholderTextColor="#c6c6c6"
                          />
                          ...
                          <View style={{}}>
                            ...
                            <View
                              ...
                              <Picker
                                ...
                                onValueChange={(value) =>
                                  this.setState({
                                    data: {...data, finalThickness2: value},
                                  })
                                }>
                                <Picker.Item
                          ...
                          <View style={{marginTop: Height(-3)}}>
                            ...
                            <View
                              ...
                              <Picker
                                ...
                                onValueChange={(value) =>
                                  this.setState({
                                    data: {...data, finalMaterial2: value},
                                  })
                                }>
                                <Picker.Item label="Select material" value="" />
                                <Picker.Item label="Dull" value="Dull" />
                        ...
                        <View style={{marginTop: Height(-1)}}>
                          ...
                          <View style={styles.txtInputView}>
                            <TextInput
                              ...
                              onChangeText={(text) =>
                                this.setState({data: {...data, width2: text}})
                              }
                              value={data.width2}
                              placeholderTextColor="#c6c6c6"
                            />
                        ...
                        <View style={{marginTop: Height(-3)}}>
                          ...
                          <View style={styles.txtInputView}>
                            <TextInput
                              ...
                              onChangeText={(text) =>
                                this.setState({data: {...data, height2: text}})
                              }
                              value={data.height2}
                              placeholderTextColor="#c6c6c6"
                            />
                        ...
                        <View style={{}}>
                          ...
                          <View
                            ...
                            <Picker
                              ...
                              onValueChange={(value) =>
                                this.setState({
                                  data: {...data, finalThickness3: value},
                                })
                              }>
                              <Picker.Item label="Select thickness" value="" />
                              <Picker.Item label="1.2MM" value="1.2" />
                        ...
                        <View style={{marginTop: Height(-3)}}>
                          ...
                          <View
                            ...
                            <Picker
                              ...
                              onValueChange={(value) =>
                                this.setState({
                                  data: {...data, finalMaterial3: value},
                                })
                              }>
                              <Picker.Item label="Select material" value="" />
                              <Picker.Item label="Dull" value="Dull" />
                      ...
                      <View style={{marginTop: Height(-1)}}>
                        ...
                        <View style={styles.txtInputView}>
                          <TextInput
                            ...
                            onChangeText={(text) =>
                              this.setState({data: {...data, width3: text}})
                            }
                            value={data.width3}
                            placeholderTextColor="#c6c6c6"
                          />
                      ...
                      <View style={{marginTop: Height(-3)}}>
                        ...
                        <View style={styles.txtInputView}>
                          <TextInput
                            ...
                            onChangeText={(text) =>
                              this.setState({data: {...data, height3: text}})
                            }
                            value={data.height3}
                            placeholderTextColor="#c6c6c6"
                          />
                          ...
                          <View style={{}}>
                            ...
                            <View
                              ...
                              <Picker
                                ...
                                onValueChange={(value) =>
                                  this.setState({
                                    data: {...data, finalThickness4: value},
                                  })
                                }>
                                <Picker.Item
                                  label="Select thickness"
                          ...
                          <View style={{marginTop: Height(-3)}}>
                            ...
                            <View
                              ...
                              <Picker
                                ...
                                onValueChange={(value) =>
                                  this.setState({
                                    data: {...data, finalMaterial4: value},
                                  })
                                }>
                                <Picker.Item label="Select material" value="" />
                                <Picker.Item label="Dull" value="Dull" />
                        ...
                        <View style={{marginTop: Height(-1)}}>
                          ...
                          <View style={styles.txtInputView}>
                            <TextInput
                              ...
                              onChangeText={(text) =>
                                this.setState({data: {...data, width4: text}})
                              }
                              value={data.width4}
                              placeholderTextColor="#c6c6c6"
                            />
                        ...
                        <View style={{marginTop: Height(-3)}}>
                          ...
                          <View style={styles.txtInputView}>
                            <TextInput
                              ...
                              onChangeText={(text) =>
                                this.setState({data: {...data, height4: text}})
                              }
                              value={data.height4}
                              placeholderTextColor="#c6c6c6"
                            />
                      ...
                      <View style={{}}>
                        ...
                        <View
                          ...
                          <Picker
                            ...
                            onValueChange={(value) =>
                              this.setState({
                                data: {...data, finalThickness9: value},
                              })
                            }
                      ...
                      <View style={{marginTop: Height(-3)}}>
                        ...
                        <View
                          ...
                          <Picker
                            ...
                            onValueChange={(value) =>
                              this.setState({
                                data: {...data, finalMaterial9: value},
                              })
                            }
                    ...
                    <View style={{marginTop: Height(-1)}}>
                      ...
                      <View style={styles.txtInputView}>
                        <TextInput
                          ...
                          onChangeText={(text) =>
                            this.setState({data: {...data, width9: text}})
                          }
                          value={data.width9}
                          placeholderTextColor="#c6c6c6"
                        />
                    ...
                    <View style={{marginTop: Height(-3)}}>
                      ...
                      <View style={styles.txtInputView}>
                        <TextInput
                          ...
                          onChangeText={(text) =>
                            this.setState({data: {...data, height9: text}})
                          }
                          value={data.height9}
                          placeholderTextColor="#c6c6c6"
                        />
            ...
            <View>
              ...
              <View
                ...
                <View style={{flexDirection: 'row'}}>
                  <TouchableOpacity
                    onPress={() => {
                      this.setState({HD02: true, HD04: false});
                    }}
                    activeOpacity={0.7}
                    style={{
                      backgroundColor: HD02,
                      padding: Width(4),
                      width: Width(43),
                      borderRadius: 5,
                    }}>
                ...
                <View
                  ...
                  <TouchableOpacity
                    onPress={() => {
                      this.setState({HD02: false, HD04: true});
                    }}
                    activeOpacity={0.7}
                    style={{
                      backgroundColor: HD04,
                      padding: Width(4),
                      width: Width(43),
                      borderRadius: 5,
                    }}>
                        ...
                        <View style={{}}>
                          ...
                          <View
                            ...
                            <Picker
                              ...
                              onValueChange={(value) =>
                                this.setState({
                                  data: {...data, finalThickness5: value},
                                })
                              }>
                              <Picker.Item label="Select thickness" value="" />
                              <Picker.Item label="1.6MM" value="1.6" />
                        ...
                        <View style={{marginTop: Height(-3)}}>
                          ...
                          <View
                            ...
                            <Picker
                              ...
                              onValueChange={(value) =>
                                this.setState({
                                  data: {...data, finalMaterial5: value},
                                })
                              }>
                              <Picker.Item label="Select material" value="" />
                              <Picker.Item label="Dull" value="Dull" />
                      ...
                      <View style={{marginTop: Height(-1)}}>
                        ...
                        <View style={styles.txtInputView}>
                          <TextInput
                            ...
                            onChangeText={(text) =>
                              this.setState({data: {...data, width5: text}})
                            }
                            value={data.width5}
                            placeholderTextColor="#c6c6c6"
                          />
                      ...
                      <View style={{marginTop: Height(-3)}}>
                        ...
                        <View style={styles.txtInputView}>
                          <TextInput
                            ...
                            onChangeText={(text) =>
                              this.setState({data: {...data, height5: text}})
                            }
                            value={data.height5}
                            placeholderTextColor="#c6c6c6"
                          />
                          ...
                          <View style={{}}>
                            ...
                            <View
                              ...
                              <Picker
                                ...
                                onValueChange={(value) =>
                                  this.setState({
                                    data: {...data, finalThickness6: value},
                                  })
                                }>
                                <Picker.Item
                                  label="Select thickness"
                          ...
                          <View style={{marginTop: Height(-3)}}>
                            ...
                            <View
                              ...
                              <Picker
                                ...
                                onValueChange={(value) =>
                                  this.setState({
                                    data: {...data, finalMaterial6: value},
                                  })
                                }>
                                <Picker.Item label="Select material" value="" />
                                <Picker.Item label="Dull" value="Dull" />
                        ...
                        <View style={{marginTop: Height(-1)}}>
                          ...
                          <View style={styles.txtInputView}>
                            <TextInput
                              ...
                              onChangeText={(text) =>
                                this.setState({data: {...data, width6: text}})
                              }
                              value={data.width6}
                              placeholderTextColor="#c6c6c6"
                            />
                        ...
                        <View style={{marginTop: Height(-3)}}>
                          ...
                          <View style={styles.txtInputView}>
                            <TextInput
                              ...
                              onChangeText={(text) =>
                                this.setState({data: {...data, height6: text}})
                              }
                              value={data.height6}
                              placeholderTextColor="#c6c6c6"
                            />
                        ...
                        <View style={{}}>
                          ...
                          <View
                            ...
                            <Picker
                              ...
                              onValueChange={(value) =>
                                this.setState({
                                  data: {...data, finalThickness7: value},
                                })
                              }>
                              <Picker.Item label="Select thickness" value="" />
                              <Picker.Item label="1.6MM" value="1.6" />
                        ...
                        <View style={{marginTop: Height(-3)}}>
                          ...
                          <View
                            ...
                            <Picker
                              ...
                              onValueChange={(value) =>
                                this.setState({
                                  data: {...data, finalMaterial7: value},
                                })
                              }>
                              <Picker.Item label="Select material" value="" />
                              <Picker.Item label="Dull" value="Dull" />
                      ...
                      <View style={{marginTop: Height(-1)}}>
                        ...
                        <View style={styles.txtInputView}>
                          <TextInput
                            ...
                            onChangeText={(text) =>
                              this.setState({data: {...data, width7: text}})
                            }
                            value={data.width7}
                            placeholderTextColor="#c6c6c6"
                          />
                      ...
                      <View style={{marginTop: Height(-3)}}>
                        ...
                        <View style={styles.txtInputView}>
                          <TextInput
                            ...
                            onChangeText={(text) =>
                              this.setState({data: {...data, height7: text}})
                            }
                            value={data.height7}
                            placeholderTextColor="#c6c6c6"
                          />
                          ...
                          <View style={{}}>
                            ...
                            <View
                              ...
                              <Picker
                                ...
                                onValueChange={(value) =>
                                  this.setState({
                                    data: {...data, finalThickness8: value},
                                  })
                                }>
                                <Picker.Item
                                  label="Select thickness"
                          ...
                          <View style={{marginTop: Height(-3)}}>
                            ...
                            <View
                              ...
                              <Picker
                                ...
                                onValueChange={(value) =>
                                  this.setState({
                                    data: {...data, finalMaterial8: value},
                                  })
                                }>
                                <Picker.Item label="Select material" value="" />
                                <Picker.Item label="Dull" value="Dull" />
                        ...
                        <View style={{marginTop: Height(-1)}}>
                          ...
                          <View style={styles.txtInputView}>
                            <TextInput
                              ...
                              onChangeText={(text) =>
                                this.setState({data: {...data, width8: text}})
                              }
                              value={data.width8}
                              placeholderTextColor="#c6c6c6"
                            />
                        ...
                        <View style={{marginTop: Height(-3)}}>
                          ...
                          <View style={styles.txtInputView}>
                            <TextInput
                              ...
                              onChangeText={(text) =>
                                this.setState({data: {...data, height8: text}})
                              }
                              value={data.height8}
                              placeholderTextColor="#c6c6c6"
                            />
    ...
    return (
      <View style={{flex: 1, backgroundColor: '#fff'}}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={{}}>{this.topMenuDesign()}</View>
        </ScrollView>
      </View>
    );
  }
