...
export default class MyChallenges extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            index: 0,
            routes: [
                { key: 'first', title: 'On going Challenges' },
                { key: 'second', title: 'Completed Challenges' },
            ],
    ...
    FirstRoute = () => (
        this.ListDesign(this.state.OnGoingChallenges)
    );
    ...
    render() {
        return (
            <View style={styles.mainContainer}>
                ...
                <MyHeader title="My Challenges" navigation={this.props.navigation} />
                <TabView
