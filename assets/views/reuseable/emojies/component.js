    ...
    render() {
        ...
        const Searchbar = (
            <View style={styles.searchbar_container}>
                <TextInput
                    style={[styles.search, { color: theme.text, ...mediumTextFont }]}
                    placeholder={placeholder}
                    clearButtonMode="always"
                    returnKeyType="done"
                    autoCorrect={false}
                    underlineColorAndroid={theme.dimBackground}
                    value={searchQuery}
                    ...
                    {isReady ? (
                        <View style={{ flex: 1 }}>
                            ...
                            <View style={styles.loader} {...other}>
                                <ActivityIndicator
                                    size={"large"}
                                    color={Platform.OS === "android" ? theme.dimBackground : "#000000"}
                                />
                            </View>
                        )}
                </View>
