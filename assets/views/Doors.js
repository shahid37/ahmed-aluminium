...
class Home extends React.Component {
  ...
  calc = () => {
    ...
    var num2 = parseFloat(this.state.data.height / 12);
    var num4 = parseFloat(this.state.data.width2 / 12);
    var num5 = parseFloat(this.state.data.height2 / 12);
    //alert(num1)
    ...
    //D50A
    if (this.state.data.finalThickness2 == 'Normal') {
    ...
    if (this.state.data.finalThickness2 == 1.6) {
      if (this.state.data.finalMaterial2 == 'Dull') {
        var b = 268;
      }
      if (this.state.data.finalMaterial2 == 'H23') {
    ...
    if (this.state.data.finalThickness2 == 2.0) {
      if (this.state.data.finalMaterial2 == 'Dull') {
        var b = 329;
      }
      if (this.state.data.finalMaterial2 == 'H23') {
